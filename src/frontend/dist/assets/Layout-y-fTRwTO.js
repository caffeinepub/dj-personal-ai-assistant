import { r as reactExports, j as jsxRuntimeExports, aa as React, ab as ReactDOM, R as React$1, a6 as reactDomExports, f as useTasks, k as ue, ac as useInternetIdentity, ad as useLocation, o as useContextEngine, L as Link } from "./index-D4lUgCCM.js";
import { u as useComposedRefs, c as createLucideIcon, f as createSlot, h as composeRefs, a as cn, B as Button } from "./createLucideIcon-a11X8bAo.js";
import { P as Primitive, d as dispatchDiscreteCustomEvent, A as AnimatePresence, m as motion, G as GraduationCap } from "./proxy-CDDWEtkX.js";
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(90deg, transparent 0%, oklch(0.75 0.18 195 / 0.5) 50%, transparent 100%)",
  ...
  reactExports.useEffect(() => {
    const checkReminders = () => {
      ...
      for (const task of currentTasks) {
        ...
        if (now >= deadlineMs + thirtyMin && localStorage.getItem(firedKey) && !ackVal && !localStorage.getItem(followupKey)) {
    ...
    checkReminders();
    const intervalRef = setInterval(checkReminders, 6e4);
    return () => clearInterval(intervalRef);
  }, []);
  const dismissBanner = (taskId) => {
    localStorage.setItem(`dj_reminder_ack_${taskId}`, "acknowledged");
    setBanners((prev) => prev.filter((b) => b.taskId !== taskId));
  };
  if (banners.length === 0) return null;
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1 p-2", children: banners.map((banner) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Bell, { className: "h-4 w-4 shrink-0 text-yellow-400 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-yellow-300", children: [
              "Reminder: ",
              banner.taskTitle
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-yellow-400/80", children: [
              "Was due at ",
              formatTime(banner.dueTime)
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
              onClick: () => setBanners(
                (prev) => prev.filter((b) => b.taskId !== banner.taskId)
              ),
...
function Layout({ children }) {
  ...
  const allNavItems = [
    ...
    { path: "/tasks", icon: SquareCheckBig, label: "Tasks" },
    { path: "/notes", icon: StickyNote, label: "Notes" },
    { path: "/finance", icon: DollarSign, label: "Finance" },
    { path: "/memory", icon: Brain, label: "Memory" },
    { path: "/plans", icon: Map$1, label: "Plans" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex min-h-screen flex-col bg-[#060b14]", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ProactiveReminders, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed left-0 top-0 z-40 hidden h-full w-16 flex-col items-center border-r border-white/5 bg-[#060b14]/95 py-4 backdrop-blur-xl md:flex", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-6 flex h-10 w-10 items-center justify-center rounded-xl border border-cyan-500/40 bg-cyan-500/10", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-sm font-bold text-cyan-400", children: "DJ" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-1 flex-col items-center gap-1 overflow-y-auto", children: allNavItems.map(({ path, icon: Icon, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            title: label,
            className: `group relative flex h-10 w-10 items-center justify-center rounded-xl transition-all ${active ? "bg-cyan-500/20 text-cyan-400" : "text-white/30 hover:bg-white/5 hover:text-white/70"}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-4.5 w-4.5" }),
              active && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-0 top-1/2 h-4 w-0.5 -translate-y-1/2 rounded-r bg-cyan-400" })
            ]
          },
          path
        );
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex-1 md:ml-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed bottom-0 left-0 right-0 z-40 flex items-center justify-around border-t border-white/5 bg-[#060b14]/95 px-2 pb-safe pt-2 backdrop-blur-xl md:hidden", children: [
      mobileNavItems.map(({ path, icon: Icon, label }) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            className: `flex min-h-[44px] flex-col items-center gap-0.5 rounded-lg px-3 py-1.5 text-[10px] transition-all ${active ? "text-cyan-400" : "text-white/30 hover:text-white/60"}`,
            children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          DropdownMenuContent,
          {
            ...
            children: mobileMoreItems.map(({ path, icon: Icon, label }) => /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Link,
              {
                to: path,
