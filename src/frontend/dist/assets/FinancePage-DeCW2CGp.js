import { g as useFinanceEntries, o as useContextEngine, X as useAddFinanceEntry, Y as useDeleteFinanceEntry, r as reactExports, j as jsxRuntimeExports, k as ue } from "./index-BwLrJvZd.js";
import { A as AlertDialog, a as AlertDialogContent, b as AlertDialogHeader, c as AlertDialogTitle, d as AlertDialogDescription, e as AlertDialogFooter, f as AlertDialogCancel, g as AlertDialogAction } from "./alert-dialog-DhzTaCeg.js";
import { B as Badge } from "./badge-Bm9B0XLL.js";
import { c as createLucideIcon, B as Button } from "./createLucideIcon-S1t9ukzj.js";
import { C as Card, d as CardContent, a as CardHeader, b as CardTitle } from "./card-3fUEoe9A.js";
...
import { T as TrendingUp, a as TrendingDown } from "./trending-up-CWXzes8g.js";
...
function FinancePage() {
  ...
  const totalIncome = reactExports.useMemo(
    () => entries.filter((e) => e.entryType === "income").reduce((s, e) => s + Number(e.amount), 0) / 100,
    [entries]
  );
  const totalExpenses = reactExports.useMemo(
    () => entries.filter((e) => e.entryType === "expense").reduce((s, e) => s + Number(e.amount), 0) / 100,
    [entries]
  );
  ...
  const djSummary = reactExports.useMemo(() => {
    var _a;
    const monthIncome = filteredEntries.filter((e) => e.entryType === "income").reduce((s, e) => s + Number(e.amount), 0) / 100;
    const monthExpense = filteredEntries.filter((e) => e.entryType === "expense").reduce((s, e) => s + Number(e.amount), 0) / 100;
