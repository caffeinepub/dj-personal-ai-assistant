import { j as jsxRuntimeExports, B as commonjsGlobal, C as getDefaultExportFromCjs, r as reactExports, R as React, D as useSaveExcelFile, E as useExcelFiles, k as ue } from "./index-2tSro1uY.js";
import { B as Badge } from "./badge-DxkoUWq4.js";
import { a as cn, b as clsx, B as Button } from "./createLucideIcon-D-Rg7iUN.js";
import { C as Card, a as CardHeader, b as CardTitle, c as CardDescription, d as CardContent } from "./card-DCklJiMc.js";
import { I as Input } from "./input-CNjN97rV.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-BHlJaflZ.js";
import { L as Layout } from "./Layout-Bj6Hma8c.js";
import { L as LoaderCircle } from "./loader-circle-BB3G_00q.js";
import { U as Upload } from "./upload-Cs1pGSrL.js";
import { D as Download } from "./download-k2kihQYv.js";
import "./proxy-BPmU2nQ0.js";
...
const parseSpreadsheet = {
  read: (buffer, filename) => {
    ...
    const rows = isCSV ? parseCSV(text) : parseCSV(text);
    return { SheetNames: ["Sheet1"], Sheets: { Sheet1: rows } };
  },
  sheetToJson: (rows) => rows,
  jsonToCSV: (data) => {
    if (data.length === 0) return "";
    const keys2 = Object.keys(data[0]);
    const header = keys2.join(",");
    const body = data.map((row) => keys2.map((k2) => JSON.stringify(row[k2] ?? "")).join(",")).join("\n");
    return `${header}
${body}`;
  }
};
function parseCSV(text) {
  ...
  return lines.slice(1).map((line) => {
    const values = line.split(",").map((v2) => v2.trim().replace(/^"|"$/g, ""));
    const row = {};
    headers.forEach((h2, i) => {
      const val = values[i] ?? "";
      row[h2] = Number.isNaN(Number(val)) || val === "" ? val : Number(val);
    });
    return row;
  });
}
function ExcelPage() {
  ...
  const [uploadedData, setUploadedData] = reactExports.useState([]);
  const [columns, setColumns] = reactExports.useState([]);
  const [question, setQuestion] = reactExports.useState("");
  const [analysisResult, setAnalysisResult] = reactExports.useState("");
  const handleFileUpload = async (e3) => {
    var _a;
    ...
    try {
      ...
      ue.error("Failed to parse file. Please use a CSV file.");
    }
  };
  ...
  const analyzeQuestion = () => {
    ...
    if (numericCols.length === 0) {
      ...
      const col = numericCols.find((c2) => lowerQ.includes(c2.toLowerCase())) || numericCols[0];
      ...
      const col = numericCols.find((c2) => lowerQ.includes(c2.toLowerCase())) || numericCols[0];
      const avg = uploadedData.reduce((sum, row) => sum + (Number(row[col]) || 0), 0) / uploadedData.length;
      result = `The average of ${col} is ${avg.toFixed(2)}`;
    } else if (lowerQ.includes("max") || lowerQ.includes("highest")) {
      const col = numericCols.find((c2) => lowerQ.includes(c2.toLowerCase())) || numericCols[0];
      const max2 = Math.max(...uploadedData.map((row) => Number(row[col]) || 0));
      result = `The maximum ${col} is ${max2}`;
    } else if (lowerQ.includes("min") || lowerQ.includes("lowest")) {
      const col = numericCols.find((c2) => lowerQ.includes(c2.toLowerCase())) || numericCols[0];
      const min2 = Math.min(...uploadedData.map((row) => Number(row[col]) || 0));
      result = `The minimum ${col} is ${min2}`;
    } else {
  ...
  const downloadData = () => {
    ...
    a2.href = url;
    a2.download = (fileName == null ? void 0 : fileName.replace(/\.(xlsx|xls)$/i, ".csv")) || "export.csv";
    a2.click();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto space-y-6 px-4 py-8", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "glow-text font-display text-3xl font-bold", children: "Excel Analysis" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground", children: "Upload and analyze spreadsheets with DJ" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glow-border border-primary/50", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Upload File" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Supports .xlsx, .xls, and .csv files" })
      ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Button,
            {
              ...
              children: saveFile.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-5 w-5 animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-5 w-5" })
            }
          )
        ] }),
        fileName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { variant: "outline", className: "border-primary", children: [
            "Loaded: ",
            fileName
          ] }),
    ...
    uploadedData.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glow-border border-secondary/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Ask DJ About Your Data" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Try: What is the total of Sales? or Show me the average Price" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Input,
              {
                ...
                value: question,
                onChange: (e3) => setQuestion(e3.target.value),
                onKeyDown: (e3) => e3.key === "Enter" && analyzeQuestion()
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
          ...
          analysisResult && /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "bg-secondary/10 border-secondary/50", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg", children: analysisResult }) }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "glow-border border-primary/50", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { children: "Data View" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "table", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsList, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "bar", children: "Bar Chart" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TabsTrigger, { value: "line", children: "Line Chart" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            TabsContent,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: col }, col)) }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: uploadedData.slice(0, 50).map((row) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                  TableRow,
                  {
                    children: columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: String(row[col] ?? "") }, col))
                  },
                  Object.values(
                    row
                  ).join("-")
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "bar", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 400, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(BarChart, { data: getChartData(), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CartesianGrid,
              {
                strokeDasharray: "3 3",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(YAxis, { stroke: "oklch(var(--foreground))" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Tooltip,
              {
                contentStyle: {
            ...
            getNumericColumns().slice(0, 3).map((col, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              Bar,
              {
                dataKey: col,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "line", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 400, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(LineChart, { data: getChartData(), children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              CartesianGrid,
              {
                strokeDasharray: "3 3",
