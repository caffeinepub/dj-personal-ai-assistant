import { r as reactExports, j as jsxRuntimeExports, n as useActor, a4 as useQuery, p as useQueryClient, a5 as useMutation, k as ue } from "./index-oO8bVSco.js";
...
import { S as Skeleton } from "./skeleton-CDfEqwJB.js";
...
import { L as Layout, H as HudBackground, B as Brain, X } from "./Layout-CqrLZaOw.js";
import { m as motion, A as AnimatePresence } from "./proxy-Bw7dCOkz.js";
...
function useMemoryNodes() {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      if (!actor) return [];
      const raw = await actor.getAllMemories();
